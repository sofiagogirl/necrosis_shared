...
class SpatialTransformer(Layer):
    ...
    def call(self, inputs):
        ...
        vol = inputs[0]
        # print('this is call function volume shape')
        # print(vol.shape)
        trf = inputs[1]
        # print('this is trf shape in call function')
        # print(trf.shape)

        # print('this is inshape')
        # print(self.inshape[1])

        # necessary for multi_gpu models...
        #vol = K.reshape(vol, [-1, *self.inshape[0][1:]])
        #trf = K.reshape(trf, [-1, *self.inshape[1][1:]])

        # print('this is trf shape for multi-gpu models')
        # print(vol.shape)
        # print(trf.shape)
        ...
        if self.single_transform:
            ...
            # print('# map transform across batch trf[0,:]')
            # print(trf[0,:].shape)
            return tf.map_fn(fn, vol, dtype=tf.float32)
        else:
            # print('# map transform across else vol and trf shape')
            # print(vol.shape)
            # print(trf.shape)
    ...
    def _single_transform(self, inputs):
        # print('this is single transform volume shape')
        # print(inputs[0].shape)
        # print('this is _single transform shape')
